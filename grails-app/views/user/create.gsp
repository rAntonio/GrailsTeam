...
<div class="section-container">
    <div class="section-contenue">
        <div class="section-contenue-form-container">
            <form id="edit-user-form" name="edit-user-form" action="${createLink(controller:"user",action:"save")}" method="POST" enctype="multipart/form-data">
                <div class="section-contenue-input">
                    <label>Utilisateur</label>
                    <input type="text" name="username" value="" required=""  class="form-contenue-control">
                ...
                <div class="section-contenue-input">
                    ...
                    <input type="password" name="password" required="" value=""   class="form-contenue-control" >
                    <div>
                        <span >Minimum 6 charactere</span>
                    </div>
                </div>
                <div class="section-contenue-input">
                    <label for="passwordExpired">Password Expired</label>
                    <input type="hidden" name="_passwordExpired"><input type="checkbox"  class="form-contenue-control" name="passwordExpired" id="passwordExpired">
                </div>
                <div class="section-contenue-input">
                    <label for="accountLocked">Account Locked</label><input type="hidden"  class="form-contenue-control" name="_accountLocked"><input type="checkbox" name="accountLocked" id="accountLocked">
                </div>
                <div class="section-contenue-input">
                    <label for="accountExpired">Account Expired</label><input type="hidden"  class="form-contenue-control" name="_accountExpired"><input type="checkbox" name="accountExpired" id="accountExpired">
                </div>
                <div class="section-contenue-input">
    ...
    <div class="section-menu">
        <div class="section-menu-container">
            <div class="section-menu-widget status-widget">
                ...
                <button class="custom-button custom-button-success validator" data-form-id="edit-user-form">Inserer</button>
                <div class="notice">
